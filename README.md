...
| Web app | Tautan web app yang digunakan untuk mengakses model serving. Contoh: [churn-model](https://churn-modelling-pipeline-production.up.railway.app/v1/models/churn-model/metadata)|
